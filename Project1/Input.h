...
#define RIGHTSTICK_UP			0x00000010l	// PS4:右スティック上(.lRz<16383)
#define RIGHTSTICK_DOWN			0x00000020l	// PS4:右スティック下(.lRz>49150)
#define RIGHTSTICK_RIGHT		0x00000040l // PS4:右スティック右(.lZ<16383)
#define RIGHTSTICK_LEFT			0x00000080l // PS4:右スティック左(.lZ>49150)
...
#define BUTTON_L1				0x00010000l	// Xbox:LBボタン	PS4：L1ボタン(.rgbButtons[4]&0x80)
#define BUTTON_R1				0x00020000l	// Xbox:RBボタン	PS4：R1ボタン(.rgbButtons[5]&0x80)
#define BUTTON_BACK				0x00040000l	// Xbox:BACKボタン
#define BUTTON_START			0x00080000l	// XboxSTARTボタン
#define BUTTON_L3				0x00100000l	// Xbox:L3ボタン(.rgbButtons[8]&0x80)
#define BUTTON_OPTION			0x00200000l	// Xbox:R3ボタン(.rgbButtons[9]&0x80) PS4 : OPTION
